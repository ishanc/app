...
SET csod.mandatory = "Mandatory", csod.field_type = "Char", csod.char_length = "250", csod.default_values = "", csod.accepted_values = ""
...
SET csod.mandatory = "Optional", csod.field_type = "Char", csod.char_length = "250", csod.default_values = "Portal Default Thumbnail", csod.accepted_values = ""
MERGE (f)-[:OUTPUTS_FIELD]->(csod);
...
SET csod.mandatory = "Mandatory", csod.field_type = "Char", csod.char_length = "250", csod.default_values = "ILT Content", csod.accepted_values = ""
MERGE (st)-[:MAPS_TO]-> (csod)
MERGE (f)-[:OUTPUTS_FIELD]->(csod);

MERGE (f:File {name: "Activity_Events"})
MERGE (csod:CSODField {name: "Secondary Vendor/Provider", file: "Activity_Events" })
SET csod.mandatory = "Optional", csod.field_type = "Char", csod.char_length = "250", csod.default_values = "", csod.accepted_values = ""
MERGE (f)-[:OUTPUTS_FIELD]->(csod);
...
SET csod.mandatory = "Optional", csod.field_type = "Integer", csod.char_length = "250", csod.default_values = "0", csod.accepted_values = ""
MERGE (f)-[:OUTPUTS_FIELD]->(csod);
...
SET csod.mandatory = "Mandatory", csod.field_type = "Char", csod.char_length = "250", csod.default_values = "Online Content", csod.accepted_values = ""
MERGE (st)-[:MAPS_TO]-> (csod)
MERGE (f)-[:OUTPUTS_FIELD]->(csod);
